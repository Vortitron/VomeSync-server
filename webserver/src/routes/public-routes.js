	...
	(_req, res) => {
		...
		return res.json({
			...
			data: {
				...
				premiumMaxPrivate: Number(limits.premiumMaxSwitches) || 50,
				premiumMaxPublic: Number(limits.premiumMaxPublicSwitches) || 25,
				premiumMaxSwitches: Number(limits.premiumMaxSwitches) || 50,
