	...
	(_req, res) => {
		...
		return res.json({
			...
			data: {
				...
				premiumMaxPrivate: Number(limits.premiumMaxSwitches) || 150,
				premiumMaxPublic: Number(limits.premiumMaxPublicSwitches) || 120,
				premiumMaxSwitches: Number(limits.premiumMaxSwitches) || 150,
